...
Реализовал свой вариант алгоритма Хаффмана, реализацию преподавателя изучил уже после написания кода
"""
import collections

input_str = 'beep beer boop!'
...
print(f'Словарь содержащий структуру древа: {dict_tree}')
print(f'Словарь содержащий коды символов: {res_bin_dict(list_val, dict_tree)}')
